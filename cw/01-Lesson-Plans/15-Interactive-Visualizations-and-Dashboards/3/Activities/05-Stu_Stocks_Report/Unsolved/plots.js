...
function buildPlot() {
  var url = `https://www.quandl.com/api/v3/datasets/WIKI/MSFT.json?start_date=2017-01-01&end_date=2018-11-22&api_key=${apiKey}`;
  ...
  d3.json(url).then(function(data) {
    ...
    var layout = {
      title:{ text:`<b>${stock} closing prices</b>`,
        font: {
